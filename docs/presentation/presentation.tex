...
% ── Slide 1 · Title ─────────────────────────────────────
{
  ...
  \begin{frame}[plain]
    ...
    \vspace{1.2cm}
    \begin{center}
      {\LARGE\bfseries\color{white}\inserttitle}\\[0.6em]
      {\normalsize\color{sky!70!white}\insertsubtitle}\\[1.5em]
      {\small\color{white!90}\insertauthor}\\[0.3em]
      {\footnotesize\color{white!70}\insertdate}
    \end{center}
  \end{frame}
}
